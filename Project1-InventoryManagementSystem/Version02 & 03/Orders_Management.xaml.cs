...
using System.Configuration; // Add this to read connection strings from app.config
...
namespace VP_2
{
    public partial class Orders_Management : Window
    {
        ...
        private string connectionString = ConfigurationManager.ConnectionStrings["InventoryManagementSystem"].ConnectionString;
